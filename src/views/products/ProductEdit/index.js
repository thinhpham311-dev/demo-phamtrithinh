...
const ProductEdit = () => {
	...
	const popNotification = (keyword) => {
		toast.push(
			<Notification title={`Cập nhật ${keyword} thành công`} type="success" duration={2500}>
				Bạn đã cập nhật sản phẩm {keyword} thành công
			</Notification>
			, {
	...
	return (
		<>
			<h3 className="mb-5 font-bold">Cập nhật sản phẩm</h3>
